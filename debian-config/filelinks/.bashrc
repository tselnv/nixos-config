...
# added by kolay
alias fix-switch-layout='setxkbmap -option grp:alt_shift_toggle "us,ru" # -option grp_led:caps'
...
alias wifi='nmcli device wifi connect "$WIFI_SSID" password "$WIFI_PASSWORD"' # to remove conection: nmcli connection delete Romashka_5G
